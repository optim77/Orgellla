...
@section('promo')
    ...
    <div class="container ">
        <div class="row">
            <div class="col-sm-3 text-center table-bordered">Kupione</div>
            <div class="col-sm-3 text-center table-bordered">Dane</div>
            <div class="col-sm-3 text-center table-bordered">Reklamacje</div>
            <div class="col-sm-3 text-center table-bordered"><a href="" >Wystaw przedmiot</a></div>
